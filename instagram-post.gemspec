...
Gem::Specification.new do |spec|
  ...
  spec.files         = ['lib/instagram/post.rb', 'lib/instagram/post/auth.rb', 'lib/instagram/post/version.rb', 'lib/instagram/post/scope.rb', 'lib/instagram/post/link.rb', 'lib/instagram/post/config.rb', 'lib/instagram/post/token.rb', 'lib/instagram/post/token_link.rb', 'lib/instagram/post/ids.rb', 'lib/instagram/post/account.rb', 'lib/instagram/post/publish.rb']
  spec.bindir        = "exe"
